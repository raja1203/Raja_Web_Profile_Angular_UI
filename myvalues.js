app.value('org_summary',
	[
						...
						},
						{
						    ...
						    roles_rspnsblts :[{role_name:'Development  manager',
...

						{
						    ...
						    roles_rspnsblts :[{role_name:'Transition Lead ',
						...
						},
						{
						    ...
						    roles_rspnsblts :[{role_name:'Delivery Manager',
						...
						},
						{
						    ...
						    roles_rspnsblts :[{role_name:'Program manager',
